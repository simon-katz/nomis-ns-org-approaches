(ns com.nomistech.ns-org-approaches.a1-multiple-exposed.test.test
  (:require [midje.sweet :refer :all]
            [com.nomistech.ns-org-approaches.a1-multiple-exposed.src.protocols
             :refer :all]
            [com.nomistech.ns-org-approaches.a1-multiple-exposed.src.records
             :refer :all]
            [com.nomistech.ns-org-approaches.a1-multiple-exposed.src.other
             :refer :all]
